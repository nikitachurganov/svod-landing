...
CONTENT_DEFAULTS = {
    ...
    # Блок опроса на лендинге (между «Меньше ручной работы» и «Команда»)
    "survey_cta_title": "Помогите сделать продукт лучше",
    "survey_cta_description": "Пройдите короткий опрос (5-7 минут)",
    "survey_cta_btn": "Пройти опрос",
